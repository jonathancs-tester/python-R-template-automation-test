...
model_spec = {
        ...
        'accuracy_crit': 'MAPE',
        'info_crit': 'AIC',
        'exclusions': [["IDV_RJ_servicos_industriais", "IDV_RJ_outros_Servicos"]],
        'golden_variables': ["z_PIB_servicos_RJ"],
        'fill_forecast': True,
        'cv_summary': 'mean',
        'selection_methods': {
            'lasso': True,
        ...
        'allowdrift': True,
        'user_model': [["IDV_RJ_servicos_industriais", "IDV_RJ_outros_Servicos"]]
