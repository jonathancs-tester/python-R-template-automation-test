...
library(faas4i)
    ...
    forecast_pack_1 <- readRDS("cypress/fixtures/Forecast/Anual/pim.rds")
    forecast_pack_2 <- readRDS("cypress/fixtures/Forecast/Bimestral/forecast_3_lasanha.rds")
    forecast_pack_3 <- readRDS("cypress/fixtures/Forecast/Diario/forecasts_fluxo_dia.rds")
    forecast_pack_4 <- readRDS("cypress/fixtures/Forecast/Mensal/y_hdv_dlh.rds")
    forecast_pack_5 <- readRDS("cypress/fixtures/Forecast/Semanal/brazil_cooking_cooker_4.rds")
    forecast_pack_6 <- readRDS("cypress/fixtures/Forecast/Semestral/br_semestral_npim2.rds")
    forecast_pack_7 <- readRDS("cypress/fixtures/Forecast/Trimestral/pibd.rds")
    forecast_pack_8 <- readRDS("cypress/fixtures/Forecast/Quinzenal/forecast_1_demand.rds")
    ...
    ### 4) Set Project Name  ========================================================
    project_name <- "MU02-SANITY_ALL_DATASET_TYPES"
