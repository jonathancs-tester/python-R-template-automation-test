library(faas4i)
    ...
    dataset_1 <- readxl::read_excel("cypress/fixtures/Dataset/Semanal/weekly_cooking.xlsx")
    dataset_2 <- readxl::read_excel("cypress/fixtures/Dataset/Semanal/semanal_atvos_res.xlsx")
...
### 3) Set Project Name  ==========================================================
    project_name <- "ML25-All-Dataset-Semanal"
